                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="card card-custom bg-gray-100 gutter-b card-stretch">
                            ...
                            <div class="card-header border-0 bg-success py-5">
                                <h3 class="card-title font-weight-bolder text-white">{{$user->name ?? ''}} {{$user->lname ?? ''}}</h3>
                            ...
                            <div class="card-body p-0 position-relative overflow-hidden">
                                <!--begin::Chart-->
                                <div id="" class="card-rounded-bottom bg-success" style="height: 200px"></div>
                                <!--end::Chart-->
                                ...
                                <div class="card-spacer mt-n25">
                                    ...
                                    <div class="row m-0">
                                        <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                                            ...
                                            <a href="{{url('customer/solutions')}}" class="text-warning font-weight-bold font-size-h6">
                                                Solutions
                                            </a>
                                        </div>
                                        <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                                            ...
                                            <a href="{{url("customer/profile")}}" class="text-primary font-weight-bold font-size-h6 mt-2">
                                                Profile
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row m-0">
                                        ...
                                        <div class="col bg-light-success px-6 py-8 rounded-xl">
                                            ...
                                            <a href="{{url("customer/messages")}}" class="text-success font-weight-bold font-size-h6 mt-2">
                                                Messages
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="card card-custom bg-info gutter-b" style="height: 130px">
                                    ...
                                    <div class="card-body d-flex flex-column p-0">
                                        ...
                                        <div class="flex-grow-1 card-spacer-x pt-6">
                                            <div class="text-inverse-info font-weight-bold">Your Level</div>
                                            <div class="text-inverse-info font-weight-bolder font-size-h3">{{$user->level ?? ''}}</div>
                                        </div>
                                        <!--end::Stats-->
...
{{--                                        <div id="kt_tiles_widget_5_chart" class="card-rounded-bottom" style="height: 50px"></div>--}}
                        ...
                        <div class="card card-custom bgi-no-repeat gutter-b" style="height: 175px; background-color: #4AB58E; background-position: calc(100% + 1rem) bottom; background-size: 25% auto; background-image: url({{asset('media/svg/humans/custom-1.svg')}})">
                            <!--begin::Body-->
                    ...
                    <div class="col-xl-3">
                        ...
                        <div class="card card-custom bgi-no-repeat gutter-b card-stretch" style="background-color: #1B283F; background-position: 0 calc(100% + 0.5rem); background-size: 100% auto; background-image: url({{asset('media/svg/patterns/rhone.svg')}})">
                            ...
                            <div class="card-body">
                                <div class="p-4">
                                    <h3 class="text-white font-weight-bolder my-7">Contact to Customer Service</h3>
