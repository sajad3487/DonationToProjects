                        ...
                        <div class="overflow-auto">
                            ...
                            <table class="table table-separate table-head-custom table-checkable" id="kt_datatable">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="" data-toggle="modal" data-target="#new_message_{{$solution_provider->id ?? ''}}">
                                            <i class="flaticon-chat-2 text-success mr-5"></i>
                                        </a>
                                        <div class="modal fade" id="new_message_{{$solution_provider->id ?? ''}}" role="dialog"  aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">New Conversation With {{$solution_provider->name ?? ''}}</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <i aria-hidden="true" class="ki ki-close"></i>
                                                        </button>
                                                    </div>
                                                    <div class="modal-body p-0">
                                                        ...
                                                        <div class="card-footer align-items-center">
                                                            ...
                                                            <!--begin::Compose-->
                                                                ...
                                                                <input type="number" name="destination_id" value="{{$solution_provider->id ?? ''}}" class="d-none">
