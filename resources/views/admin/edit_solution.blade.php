                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-baseline flex-wrap mr-5 mt-5">
                                    ...
                                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                        <li class="breadcrumb-item">
                                            <a href="{{url('admin/solutions')}}" class="text-muted">
                                                Solutions
                                            </a>
                                        </li>
                                        <li class="breadcrumb-item">
                                ...
                                <div class="card-toolbar">
                                        @if($solution->status == 1 )
                                            ...
                                            <a href="{{url("admin/solutions/$solution->id/publish")}}" class="btn btn-warning font-weight-bold mr-2">Publish the Solution</a>
                                                @else
                                        ...
                                        <a href="{{url("admin/solutions/$solution->id/confirm")}}" class="btn btn-light-success font-weight-bold mr-2">Confirm Solution</a>
                                ...
                                <div class="card-body p-0">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="kt_apps_contacts_view_tab_1" role="tabpanel">
                                            <div class="container">
                                                <form  action="{{url("/admin/solutions/$solution->id/update")}}" method="post" class="p-5" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Upload documents of the solution</h5>
                                                        ...
                                                        <div class="modal-body row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <form action="{{url('admin/solutions/media/store')}}" method="post" enctype="multipart/form-data">
                                                                    @csrf
                                                                    <div class="card-body p-0">
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="modal fade" id="delete_solution_{{$media->id ?? ''}}" role="dialog"  aria-hidden="true">
                                                                    <div class="modal-dialog modal-lg" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title">Remove the file</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <i aria-hidden="true" class="ki ki-close"></i>
                                                                                </button>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <div class="card-body text-center">
                                                                                    ...
                                                                                    <form action="{{url("admin/solutions/media/$media->id/delete")}}" method="post">
                                                                                        @csrf
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body row">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <form action="{{url("admin/solutions/media/".$solution->main_image->id."/update")}}" method="post" enctype="multipart/form-data">
                                                                                @csrf
                                                                                @method('PUT')
                                                                                <div class="card-body p-0">
                                                                                    <h3 class="mb-5">
                                                                    ...
                                                                    <div class="modal-dialog modal-lg" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <!--begin::Form-->
                                                                                <div class="card-body text-center">
                                                                                    <h3 class="mb-4">Are you sure you want to delete "{{$comment->user->name ?? ''}}" ?</h3>
                                                                                    <p class="my-4">This solution will be remove immediately</p>

                                                                                    <form action="{{url("admin/solutions/comments/$comment->id/delete")}}" method="post">
                                                                                        @csrf
                                                                                        <button data-dismiss="modal" aria-label="Close" class="btn btn-light font-weight-bolder mr-5">
                                                                                            Cancel
                                                                                        </button>
