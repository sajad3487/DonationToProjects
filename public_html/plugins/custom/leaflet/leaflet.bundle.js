...
!function (t, i) {
    ...
    var tt = document.documentElement.style, it = "ActiveXObject" in window, et = it && !document.addEventListener,
        ...
        zt = xt && ut, Mt = xt && ct,
        Ct = 1 < (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI), St = function () {
            var t = !1;
            try {
            ...
            return t
        }, Et = !!document.createElement("canvas").getContext, Zt = !(!document.createElementNS || !$("svg").createSVGRect),
        kt = !Zt && function () {
            try {
    ...
    function Ii(i, t, e, n) {
        ...
        bt && 0 === t.indexOf("touch") ? Ft(i, t, s, o) : !Tt || "dblclick" !== t || bt && lt ? "addEventListener" in i ? "mousewheel" === t ? i.addEventListener("onwheel" in i ? "wheel" : "mousewheel", s, !!St && {passive: !1}) : "mouseenter" === t || "mouseleave" === t ? (s = function (t) {
    ...
    function Hi(t, i) {
        ...
        var e = Ei(i), n = e.boundingClientRect;
        ...
        ce = k.extend({
            options: {clickTolerance: 3}, initialize: function (t, i, e, n) {
                ...
                if (!t._simulated && this._enabled && (this._moved = !1, !pi(this._element, "leaflet-zoom-anim") && !(ce._dragging || t.shiftKey || 1 !== t.which && 1 !== t.button && !t.touches || ((ce._dragging = this)._preventOutline && Mi(this._element), Ti(), Qt(), this._moving)))) {
                    this.fire("down");
                    var i = t.touches ? t.touches[0] : t, e = Si(this._element);
    ...
    }), Ce = h({}, U, {code: "EPSG:4326", projection: be, transformation: K(1 / 180, 1, -1 / 180, .5)}), Se = h({}, F, {
...
!function (t, e) {
    ...
    var e = window.XMLHttpRequest && "withCredentials" in new window.XMLHttpRequest,
        i = "" === document.documentElement.style.pointerEvents, a = {cors: e, pointerEvents: i},
        s = {attributionWidthOffset: 55}, n = 0;
    ...
    function u(s, r) {
        ...
        return o.onerror = function (t) {
            o.onreadystatechange = f.Util.falseFn, s.call(r, {
                error: {
                    code: 500,
            ...
            if (4 === o.readyState) {
                ...
                !i && e.error && (i = e.error, e = null), o.onerror = f.Util.falseFn, s.call(r, i, e)
            }
    ...
    function h(t, e, i, s) {
        var r = l(e), o = u(i, s), n = (t + "?" + r).length;
        if (n <= 2e3 && a.cors ? o.open("GET", t + "?" + r) : 2e3 < n && a.cors && (o.open("POST", t), o.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8")), null != s && void 0 !== s.options && (o.timeout = s.options.timeout), n <= 2e3 && a.cors) o.send(null); else {
    ...
    function c(t, e, s, r) {
        ...
        var i = f.DomUtil.create("script", null, document.body);
        ...
        }, f.DomUtil.addClass(i, "esri-leaflet-jsonp"), n++, {
            id: o, url: i.src, abort: function () {
    ...
    function v(t) {
        for (var e, i, s = [], r = [], o = 0; o < t.length; o++) {
            var n, a = g(t[o].slice(0));
            a.length < 4 || (_(a) ? (n = [a.slice().reverse()], s.push(n)) : r.push(a.slice().reverse()))
        }
        for (var l, u, h, c, p = []; r.length;) {
            i = r.pop();
            for (var d = !1, m = s.length - 1; 0 <= m; m--) if (e = s[m][0], h = void 0, h = y(l = e, u = i), c = function (t, e) {
        ...
        for (; p.length;) {
            i = p.pop();
            var f = !1;
            for (m = s.length - 1; 0 <= m; m--) if (e = s[m][0], y(e, i)) {
                s[m].push(i), f = !0;
                break
            }
            f || s.push([i.reverse()])
    ...
    function b(t) {
        var e = [], i = t.slice(0), s = g(i.shift().slice(0));
        if (4 <= s.length) {
            _(s) || s.reverse(), e.push(s);
            for (var r = 0; r < i.length; r++) {
                var o = g(i[r].slice(0));
                4 <= o.length && (_(o) && o.reverse(), e.push(o))
            }
        }
        return e
    }

    var x = {request: h, get: p, post: r}, S = function t(e, i) {
        var s = {};
        if (e.features) {
  ...
  */
   ...
   * Apache-2.0 */
    ...
    function T(t) {
        ...
        var e = f.latLng(t.ymin, t.xmin), i = f.latLng(t.ymax, t.xmax);
        return f.latLngBounds(e, i)
    }

    function w(t) {
        return {
            xmin: (t = f.latLngBounds(t)).getSouthWest().lng,
    ...
    function F(t, e) {
        var i = t.features || t.results, s = i.length, r = e || P(t), o = {type: "FeatureCollection", features: []};
        if (s) for (var n = i.length - 1; 0 <= n; n--) {
            var a = A(i[n], r || R(i[n]));
            o.features.push(a)
        }
        return o
    ...
    function O(t) {
        return "/" !== (t = f.Util.trim(t))[t.length - 1] && (t += "/"), t
    }
    ...
    function D(t) {
        ...
        return t instanceof f.LatLngBounds ? (e.geometry = w(t), e.geometryType = "esriGeometryEnvelope", e) : (t.getLatLng && (t = t.getLatLng()), t instanceof f.LatLng && (t = {
            type: "Point",
            coordinates: [t.lng, t.lat]
        }), t instanceof f.GeoJSON && (t = t.getLayers()[0].feature.geometry, e.geometry = I(t), e.geometryType = U(t.type)), t.toGeoJSON && (t = t.toGeoJSON()), "Feature" === t.type && (t = t.geometry), "Point" === t.type || "LineString" === t.type || "Polygon" === t.type || "MultiPolygon" === t.type ? (e.geometry = I(t), e.geometryType = U(t.type), e) : void d("invalid geometry passed to spatial query. Should be L.LatLng, L.LatLngBounds, L.Marker or a GeoJSON Point, Line, Polygon or MultiPolygon object"))
    }

    function B(t, l) {
        a.cors && h(t, {}, f.Util.bind(function (t, e) {
            if (!t) {
                l._esriAttributions = [];
                for (var i = 0; i < e.contributors.length; i++) for (var s = e.contributors[i], r = 0; r < s.coverageAreas.length; r++) {
                    var o = s.coverageAreas[r], n = f.latLng(o.bbox[0], o.bbox[1]), a = f.latLng(o.bbox[2], o.bbox[3]);
                    l._esriAttributions.push({
                        attribution: s.attribution,
                        score: o.score,
                        bounds: f.latLngBounds(n, a),
                        minZoom: o.zoomMin,
                        maxZoom: o.zoomMax
                    })
                }
    ...
    function E(t) {
        var e = t.target, i = e._esriAttributions;
        if (e && e.attributionControl) {
            var s = e.attributionControl._container.querySelector(".esri-dynamic-attribution");
            if (s && i) {
                for (var r = "", o = e.getBounds(), n = f.latLngBounds(o.getSouthWest().wrap(), o.getNorthEast().wrap()), a = e.getZoom(), l = 0; l < i.length; l++) {
                    var u = i[l], h = u.attribution;
    ...
    var z = {
        ...
        options: {proxy: !1, useCors: e}, generateSetter: function (e, t) {
            return f.Util.bind(function (t) {
                return this.params[e] = t, this
            }, t)
        }, initialize: function (t) {
            if (t.request && t.options ? (this._service = t, f.Util.setOptions(this, t.options)) : (f.Util.setOptions(this, t), this.options.url = O(t.url)), this.params = f.Util.extend({}, this.params || {}), this.setters) for (var e in this.setters) {
            ...
            return this.options.requestParams && f.Util.extend(this.params, this.options.requestParams), this._service ? this._service.request(this.path, this.params, t, e) : this._request("request", this.path, this.params, t, e)
    ...
    var N = Z.extend({
        ...
        nearby: function (t, e) {
            return t = f.latLng(t), this.params.geometry = [t.lng, t.lat], this.params.geometryType = "esriGeometryPoint", this.params.spatialRel = "esriSpatialRelIntersects", this.params.units = "esriSRUnit_Meter", this.params.distance = e, this.params.inSr = 4326, this
        },
        where: function (t) {
    ...
    var Q = V.extend({
        setters: {
            ...
            return 2 === t.length && (t = f.latLng(t)), this._setGeometryParams(t), this
    ...
    var H = V.extend({
        setters: {
            ...
            return t = f.latLng(t), this.params.geometry = JSON.stringify({
                x: t.lng,
                y: t.lat,
                spatialReference: {wkid: 4326}
            ...
            if (t.properties && t.properties.Values && (r.pixel.properties.values = t.properties.Values), i && i.features && (r.catalogItems = F(i), s && s.length === r.catalogItems.features.length)) for (var o = s.length - 1; 0 <= o; o--) r.catalogItems.features[o].properties.catalogItemVisibility = s[o];
            return r
        }
    });
    ...
    var Y = f.Evented.extend({
        options: {proxy: !1, useCors: e, timeout: 0}, initialize: function (t) {
            t = t || {}, this._requestQueue = [], this._authenticating = !1, f.Util.setOptions(this, t), this.options.url = O(this.options.url)
            ...
            if (this.options.token && (i.token = this.options.token), this.options.requestParams && f.Util.extend(i, this.options.requestParams), !this._authenticating) {
            ...
            return f.Util.bind(function (t, e) {
                !t || 499 !== t.code && 498 !== t.code || (this._authenticating = !0, this._requestQueue.push([i, s, r, o, n]), this.fire("authenticationrequired", {authenticate: f.Util.bind(this.authenticate, this)}, !0), t.authenticate = f.Util.bind(this.authenticate, this)), o.call(n, t, e), t ? this.fire("requesterror", {
                    ...
                    response: e,
                    method: i
                }, !0), this.fire("requestend", {url: this.options.url + s, params: r, method: i}, !0)
            }, this)
        }, _runQueue: function () {
    ...
    var st = Y.extend({
        options: {idAttribute: "OBJECTID"}, query: function () {
            ...
            return t = I(t), t = 1 < e.length ? t : [t], this.post("addFeatures", {features: t}, function (t, e) {
            ...
            return t = I(t, this.options.idAttribute), t = 1 < e.length ? t : [t], this.post("updateFeatures", {features: t}, function (t, e) {
    ...
    var ot = "https:" !== window.location.protocol ? "http:" : "https:", nt = f.TileLayer.extend({
        statics: {
            TILES: {
                Streets: {
            ...
            var i;
            if ("object" == typeof t && t.urlTemplate && t.options) i = t; else {
            ...
            var s = f.Util.extend(i.options, e);
            f.Util.setOptions(this, s), this.options.token && -1 === i.urlTemplate.indexOf("token=") && (i.urlTemplate += "?token=" + this.options.token), this.options.proxy && (i.urlTemplate = this.options.proxy + "?" + i.urlTemplate), f.TileLayer.prototype.initialize.call(this, i.urlTemplate, s)
        }, onAdd: function (t) {
            q(t), "esri-labels" === this.options.pane && this._initPane(), this.options.attributionUrl && B((this.options.proxy ? this.options.proxy + "?" : "") + this.options.attributionUrl, t), t.on("moveend", E), -1 !== this._url.indexOf("World_Imagery") && t.on("zoomanim", at, this), f.TileLayer.prototype.onAdd.call(this, t)
        }, onRemove: function (t) {
            t.off("moveend", E), f.TileLayer.prototype.onRemove.call(this, t)
        }, _initPane: function () {
            var t;
    ...
    function at(t) {
        var e, s, i, r, o = t.target;
        o && (e = o.getZoom(), s = t.zoom, i = o.wrapLatLng(t.center), e < s && 13 < s && !this.options.downsampled ? (r = o.project(i, s).divideBy(256).floor(), h(f.Util.template(this._url, f.Util.extend({
            s: this._getSubdomain(r),
            x: r.x,
            y: r.y,
            z: s
        }, this.options)).replace(/tile/, "tilemap") + "/8/8", {}, function (t, e) {
            if (!t) for (var i = 0; i < e.data.length; i++) {
                if (!e.data[i]) {
                    this.options.maxNativeZoom = s - 1, this.options.downsampled = !0;
                    break
                }
                this.options.maxNativeZoom = 22
            }
        }, this)) : s < 13 && (this.options.downsampled = !1))
    }

    var lt = f.TileLayer.extend({
        options: {
        ...
        createTile: function (t, e) {
            ...
            return f.DomEvent.on(i, "load", f.Util.bind(this._tileOnLoad, this, e, i)), f.DomEvent.on(i, "error", f.Util.bind(this._tileOnError, this, e, i)), this.options.crossOrigin && (i.crossOrigin = ""), i.alt = "", !this._lodMap || this._lodMap && this._lodMap[this._getZoomForUrl()] ? i.src = this.getTileUrl(t) : this.once("lodmap", function () {
        ...
        onAdd: function (u) {
            q(u), this._lodMap || this.metadata(function (t, e) {
                if (!t && e.spatialReference) {
                    ...
                    if (!this.options.attribution && u.attributionControl && e.copyrightText && (this.options.attribution = e.copyrightText, u.attributionControl.addAttribution(this.getAttribution())), u.options.crs !== f.CRS.EPSG3857 || 102100 !== i && 3857 !== i) u.options.crs && u.options.crs.code && -1 < u.options.crs.code.indexOf(i) || d("L.esri.TiledMapLayer is using a non-mercator spatial reference. Support may be available through Proj4Leaflet http://esri.github.io/esri-leaflet/examples/non-mercator-projection.html"); else {
                        this._lodMap = {};
                        for (var s = e.tileInfo.lods, r = lt.MercatorZoomLevels, o = 0; o < s.length; o++) {
                            var n = s[o];
                            for (var a in r) {
                                var l = r[a];
            ...
            }, this), f.TileLayer.prototype.onAdd.call(this, u)
        },
        metadata: function (t, e) {
    ...
    var ut = f.ImageOverlay.extend({
        onAdd: function (t) {
            this._topLeft = t.getPixelBounds().min, f.ImageOverlay.prototype.onAdd.call(this, t)
        }, _reset: function () {
            this._map.options.crs === f.CRS.EPSG3857 ? f.ImageOverlay.prototype._reset.call(this) : f.DomUtil.setPosition(this._image, this._topLeft.subtract(this._map.getPixelOrigin()))
        }
    }), ht = f.Layer.extend({
        options: {opacity: 1, position: "front", f: "image", useCors: e, attribution: null, interactive: !1, alt: ""},
        onAdd: function (i) {
            q(i), this.options.zIndex && (this.options.position = null), this._update = f.Util.throttle(this._update, this.options.updateInterval, this), i.on("moveend", this._update, this), this._currentImage && this._currentImage._bounds.equals(this._map.getBounds()) ? i.addLayer(this._currentImage) : this._currentImage && (this._map.removeLayer(this._currentImage), this._currentImage = null), this._update(), this._popup && (this._map.on("click", this._getPopupData, this), this._map.on("dblclick", this._resetPopupState, this)), this.metadata(function (t, e) {
        ...
        bindPopup: function (t, e) {
            return this._shouldRenderPopup = !1, this._lastClick = !1, this._popup = f.popup(e), this._popupFunction = t, this._map && (this._map.on("click", this._getPopupData, this), this._map.on("dblclick", this._resetPopupState, this)), this
        },
        unbindPopup: function () {
        ...
        _renderImage: function (t, s, e) {
            if (this._map) {
                ...
                }).addTo(this._map), o = function (t) {
                    var e, i;
                    r.off("error", o, this), this._map && (e = t.target, i = this._currentImage, e._bounds.equals(s) && e._bounds.equals(this._map.getBounds()) ? (this._currentImage = e, "front" === this.options.position ? this.bringToFront() : "back" === this.options.position && this.bringToBack(), this.options.zIndex && this.setZIndex(this.options.zIndex), this._map && this._currentImage._map ? this._currentImage.setOpacity(this.options.opacity) : this._currentImage._map.removeLayer(this._currentImage), i && this._map && this._map.removeLayer(i), i && i._map && i._map.removeLayer(i)) : this._map.removeLayer(e)), this.fire("load", {bounds: s})
                };
        ...
        _update: function () {
            var t, e, i;
            this._map && (t = this._map.getZoom(), e = this._map.getBounds(), this._animatingZoom || this._map._panTransition && this._map._panTransition._inProgress || (t > this.options.maxZoom || t < this.options.minZoom ? this._currentImage && (this._currentImage._map.removeLayer(this._currentImage), this._currentImage = null) : (i = this._buildExportParams(), f.Util.extend(i, this.options.requestParams), i ? (this._requestExport(i, e), this.fire("loading", {bounds: e})) : this._currentImage && (this._currentImage._map.removeLayer(this._currentImage), this._currentImage = null))))
        },
        _renderPopup: function (t, e, i, s) {
            var r;
            t = f.latLng(t), this._shouldRenderPopup && this._lastClick.equals(t) && ((r = this._popupFunction(e, i, s)) && this._popup.setLatLng(t).setContent(r).openOn(this._map))
        },
        _resetPopupState: function (t) {
            this._shouldRenderPopup = !1, this._lastClick = t.latlng
        },
        _calculateBbox: function () {
            var t = this._map.getPixelBounds(), e = this._map.unproject(t.getBottomLeft()),
                i = this._map.unproject(t.getTopRight()), s = this._map.options.crs.project(i),
                r = this._map.options.crs.project(e), o = f.bounds(s, r);
        ...
        options: {updateInterval: 150, format: "jpgpng", transparent: !0, f: "image"}, query: function () {
            ...
            t = k(t), this.service = it(t), this.service.addEventParent(this), f.Util.setOptions(this, t)
        }, setPixelType: function (t) {
            return this.options.pixelType = t, this._update(), this
        }, getPixelType: function () {
            return this.options.pixelType
        }, setBandIds: function (t) {
            return f.Util.isArray(t) ? this.options.bandIds = t.join(",") : this.options.bandIds = t.toString(), this._update(), this
        }, getBandIds: function () {
            return this.options.bandIds
        }, setNoData: function (t, e) {
            return f.Util.isArray(t) ? this.options.noData = t.join(",") : this.options.noData = t.toString(), e && (this.options.noDataInterpretation = e), this._update(), this
        }, getNoData: function () {
            ...
            var t = f.Util.bind(function (t, e, i) {
                t || setTimeout(f.Util.bind(function () {
                    this._renderPopup(s.latlng, t, e, i)
                }, this), 300)
            }, this), e = this.identify().at(s.latlng);
            ...
            }, this) : (t.f = "image", this._renderImage(this.options.url + "exportImage" + f.Util.getParamString(t), i))
        }
    });
    var pt = ht.extend({
        options: {
            ...
            t = k(t), this.service = tt(t), this.service.addEventParent(this), t.proxy && "json" !== t.f && (t.f = "json"), f.Util.setOptions(this, t)
            ...
            if (e.params.maxAllowableOffset || e.simplify(this._map, .5), this.options.popup && this.options.popup.params && this.options.popup.params.layers || (this.options.layers ? e.layers("visible:" + this.options.layers.join(",")) : e.layers("visible")), this.options.layerDefs && "string" != typeof this.options.layerDefs && !e.params.layerDefs) for (var i in this.options.layerDefs) this.options.layerDefs.hasOwnProperty(i) && e.layerDef(i, this.options.layerDefs[i]);
            ...
            }, this) : (t.f = "image", this._renderImage(this.options.url + "export" + f.Util.getParamString(t), i))
        }
    });
    var dt = f.Layer.extend({
        options: {cellSize: 512, updateWhenIdle: f.Browser.mobile, updateInterval: 150, noWrap: !1, keepBuffer: 1.5},
        initialize: function (t) {
            f.Util.setOptions(this, t)
        },
        onAdd: function () {
        ...
        getEvents: function () {
            ...
            return this.options.updateWhenIdle || (this._onMove || (this._onMove = f.Util.throttle(this._onMoveEnd, this.options.updateInterval, this)), t.move = this._onMove), t
        },
        createCell: function () {
            return document.createElement("div")
        },
        ...
        getCellSize: function () {
            ...
            return t instanceof f.Point ? t : new f.Point(t, t)
        },
        ...
        _retainParent: function (t, e, i, s) {
            var r = Math.floor(t / 2), o = Math.floor(e / 2), n = i - 1, a = new f.Point(+r, +o);
            a.z = +n;
            var l = this._cellCoordsToKey(a), u = this._cells[l];
        ...
        _retainChildren: function (t, e, i, s) {
            for (var r = 2 * t; r < 2 * t + 2; r++) for (var o = 2 * e; o < 2 * e + 2; o++) {
                var n = new f.Point(r, o);
                n.z = i + 1;
                var a = this._cellCoordsToKey(n), l = this._cells[a];
        ...
        _resetGrid: function () {
            var t = this._map, e = t.options.crs, i = this._cellSize = this.getCellSize(), s = this._cellZoom,
        ...
        _getCelldPixelBounds: function (t) {
            var e = this._map, i = e._animatingZoom ? Math.max(e._animateToZoom, e.getZoom()) : e.getZoom(),
                s = e.getZoomScale(i, this._cellZoom), r = e.project(t, this._cellZoom).floor(),
                o = e.getSize().divideBy(2 * s);
            return new f.Bounds(r.subtract(o), r.add(o))
        },
        _update: function (t) {
            var e = this._map;
            if (e) {
                ...
                var s = this._getCelldPixelBounds(t), r = this._pxBoundsToCellRange(s), o = r.getCenter(), n = [],
                    a = this.options.keepBuffer,
                    l = new f.Bounds(r.getBottomLeft().subtract([a, -a]), r.getTopRight().add([a, -a]));
                ...
                if (1 < Math.abs(i - this._cellZoom)) this._setView(t, i); else {
                    ...
                    }), 0 !== n.length) for (this._loading || (this._loading = !0), p = 0; p < n.length; p++) this._activeCells[this._cellCoordsToKey(n[p])] ? this._reuseCell(n[p]) : this._createCell(n[p])
                }
            }
        },
        _isValidCell: function (t) {
            ...
            return f.toLatLngBounds(this.options.bounds).overlaps(s)
        },
        _keyToBounds: function (t) {
            return this._cellCoordsToBounds(this._keyToCellCoords(t))
        },
        _cellCoordsToNwSe: function (t) {
            var e = this._map, i = this.getCellSize(), s = t.scaleBy(i), r = s.add(i);
            return [e.unproject(s, t.z), e.unproject(r, t.z)]
        },
        _cellCoordsToBounds: function (t) {
            var e = this._cellCoordsToNwSe(t), i = new f.LatLngBounds(e[0], e[1]);
        ...
        _keyToCellCoords: function (t) {
            var e = t.split(":"), i = new f.Point(+e[0], +e[1]);
            return i.z = +e[2], i
        },
        ...
        _reuseCell: function (t) {
            ...
            var i = this._wrapCoords(t), s = this._cellCoordsToBounds(this._wrapCoords(t));
            this.cellEnter(s, i, e), this.fire("cellenter", {key: e, coords: i, bounds: s})
        },
        _createCell: function (t) {
            var e = this._cellCoordsToKey(t), i = this._wrapCoords(t),
                s = this._cellCoordsToBounds(this._wrapCoords(t));
            this.createCell(s, i, e), this.fire("cellcreate", {
                key: e,
                coords: i,
                bounds: s
            }), this._cells[e] = {coords: t, current: !0}, f.Util.requestAnimFrame(this._pruneCells, this)
        },
        ...
        _wrapCoords: function (t) {
            var e = new f.Point(this._wrapX ? f.Util.wrapNum(t.x, this._wrapX) : t.x, this._wrapY ? f.Util.wrapNum(t.y, this._wrapY) : t.y);
            return e.z = t.z, e
        },
        _pxBoundsToCellRange: function (t) {
            var e = this.getCellSize();
            return new f.Bounds(t.min.unscaleBy(e).floor(), t.max.unscaleBy(e).ceil().subtract([1, 1]))
        }
    });
    ...
    mt.prototype.query = function (t) {
        ...
        for (var e, i, s = 0, r = this.values.length - 1; s <= r;) if (e = (s + r) / 2 | 0, +(i = this.values[Math.round(e)]).value < +t) s = 1 + e; else {
    ...
    var ft = dt.extend({
        options: {
            ...
            if (dt.prototype.initialize.call(this, t), t = k(t), t = f.Util.setOptions(this, t), this.service = rt(t), this.service.addEventParent(this), "*" !== this.options.fields[0]) {
            ...
            }, this), r.on("zoomend", this._handleZoomChange, this), dt.prototype.onAdd.call(this, r)
        }, onRemove: function (t) {
            ...
            return this._activeRequests++, 1 === this._activeRequests && this.fire("loading", {bounds: s}, !0), this._buildQuery(s).run(function (t, e, i) {
                i && i.exceededTransferLimit && this.fire("drawlimitexceeded"), !t && e && e.features.length && f.Util.requestAnimFrame(f.Util.bind(function () {
            ...
            return e.params.resultType = "tile", this.options.requestParams && f.Util.extend(e.params, this.options.requestParams), this.options.simplifyFactor && e.simplify(this._map, this.options.simplifyFactor), "server" === this.options.timeFilterMode && this.options.from && this.options.to && e.between(this.options.from, this.options.to), e
        }, setWhere: function (t, s, r) {
            this.options.where = t && t.length ? t : "1=1";
            for (var o = [], n = [], a = 0, l = null, e = f.Util.bind(function (t, e) {
                if (t && (l = t), e) for (var i = e.features.length - 1; 0 <= i; i--) n.push(e.features[i].id);
                --a <= 0 && this._visibleZoom() && (this._currentSnapshot = n, f.Util.requestAnimFrame(f.Util.bind(function () {
                    this.removeLayers(o), this.addLayers(n), s && s.call(r, l)
                }, this)))
            }, this), i = this._currentSnapshot.length - 1; 0 <= i; i--) o.push(this._currentSnapshot[i]);
            for (var u in this._cells) {
                a++;
                var h = this._keyToCellCoords(u), c = this._cellCoordsToBounds(h);
            ...
            var o = this.options.from, n = this.options.to, a = 0, l = null, t = f.Util.bind(function (t) {
                t && (l = t), this._filterExistingFeatures(o, n, e, i), a--, s && a <= 0 && s.call(r, l)
            }, this);
            if (this.options.from = e, this.options.to = i, this._filterExistingFeatures(o, n, e, i), "server" === this.options.timeFilterMode) for (var u in this._cells) {
                a++;
                var h = this._keyToCellCoords(u), c = this._cellCoordsToBounds(h);
            ...
            if (o.indexOf) for (var n = 0; n < o.length; n++) {
                var a = r.indexOf(o[n]);
                0 <= a && r.splice(a, 1)
            }
            f.Util.requestAnimFrame(f.Util.bind(function () {
            ...
            if (this.options.timeField.start && this.options.timeField.end) var s = this._startTimeIndex.between(t, e),
                r = this._endTimeIndex.between(t, e), o = s.concat(r); else {
            ...
            if (this.options.timeField.start && this.options.timeField.end) {
                ...
                }), s.push({id: e.id, value: new Date(e.properties[this.options.timeField.end])});
            ...
            if (this.options.timeField.start && this.options.timeField.end) {
                var r = +t.properties[this.options.timeField.start], o = +t.properties[this.options.timeField.end];
            ...
            if (this._visibleZoom()) for (var t in this._cells) {
                var e = this._cells[t].coords, i = this._cacheKey(e);
            ...
            this._metadata ? i(void 0, this._metadata) : this.metadata(f.Util.bind(function (t, e) {
                this._metadata = e, i(t, this._metadata)
            }, this))
        }, addFeature: function (t, e, i) {
            this.addFeatures(t, e, i)
        }, addFeatures: function (e, o, n) {
            this._getMetadata(f.Util.bind(function (t, s) {
                var r;
                t ? o && o.call(this, t, null) : (r = e.features ? e.features : [e], this.service.addFeatures(e, f.Util.bind(function (t, e) {
                    if (!t) {
            ...
            return this.service.deleteFeatures(t, function (t, e) {
                var i = e.length ? e : [e];
                if (!t && 0 < i.length) for (var s = i.length - 1; 0 <= s; s--) this.removeLayers([i[s].objectId], !0);
                r && r.call(o, t, e)
            }, this)
        }
    }), yt = ft.extend({
        options: {cacheLayers: !0}, initialize: function (t) {
            ...
            this._visibleZoom() && !this._zooming && this._map && f.Util.requestAnimFrame(f.Util.bind(function () {
                var t = this._cacheKey(s), e = this._cellCoordsToKey(s), i = this._cache[t];
                this._activeCells[e] && i && this.addLayers(i)
            }, this))
        }, cellLeave: function (t, a) {
            this._zooming || f.Util.requestAnimFrame(f.Util.bind(function () {
                if (this._map) {
                    var t = this._cacheKey(a), e = this._cellCoordsToKey(a), i = this._cache[t],
            ...
            var e = this._layers[t], i = this._originalStyle || f.Path.prototype.options;
            return e && (f.Util.extend(e.options, e.defaultOptions), this.setFeatureStyle(t, i)), this
            ...
            var e, i, s = this._layers[t], r = s.feature;
            s && s.setIcon && this.options.pointToLayer && this.options.pointToLayer && (e = this.options.pointToLayer(r, f.latLng(r.geometry.coordinates[1], r.geometry.coordinates[0])).options.icon, s.setIcon(e)), s && s.setStyle && this.options.pointToLayer && (i = this.options.pointToLayer(r, f.latLng(r.geometry.coordinates[1], r.geometry.coordinates[0])).options, this.setFeatureStyle(r.id, i)), s && s.setStyle && this.options.style && this.resetStyle(r.id)
        }
    });
    t.BasemapLayer = nt, t.DynamicMapLayer = pt, t.FeatureLayer = yt, t.FeatureLayerService = st, t.FeatureManager = ft, t.Find = W, t.Identify = V, t.IdentifyFeatures = Q, t.IdentifyImage = H, t.ImageMapLayer = ct, t.ImageService = et, t.MapService = $, t.Query = N, t.RasterLayer = ht, t.Service = Y, t.Support = a, t.Task = Z, t.TiledMapLayer = lt, t.Util = z, t.VERSION = "2.4.1", t.basemapLayer = function (t, e) {
        return new nt(t, e)
...
!function (e, t) {
    ...
    "use strict";
    var t = "https://geocode.arcgis.com/arcgis/rest/services/World/GeocodeServer/", s = r.Task.extend({
    ...
    var a = r.Task.extend({
        ...
        within: function (e) {
            var t = (e = (e = h.latLngBounds(e)).pad(.5)).getCenter(), s = e.getNorthWest();
    ...
    var d = h.Evented.extend({
        options: {zoomToResult: !0, useMapBounds: 12, searchBounds: null}, initialize: function (e, t) {
            ...
            var i, o = 0, r = [], n = h.Util.bind(function (e, t) {
            ...
            if (e) o++, t.results(s, e, this._searchBounds(), n); else for (var a = 0; a < this._providers.length; a++) o++, this._providers[a].results(s, e, this._searchBounds(), n)
        }, _suggest: function (e) {
            var r = this._providers.length, n = 0, t = h.Util.bind(function (i, o) {
                return h.Util.bind(function (e, t) {
                    ...
                    if (t.length) for (var s = 0; s < t.length; s++) t[s].provider = o; else this._control._renderSuggestions(t);
            ...
            for (var s = 0; s < this._providers.length; s++) {
                var i = this._providers[s], o = i.suggestions(e, this._searchBounds(), t(e, i));
    ...
    var g = u.extend({
        options: {label: "Places and Addresses", maxResults: 5}, suggestions: function (e, t, r) {
            var s = this.suggest().text(e);
            return t && s.within(t), this.options.countries && s.countries(this.options.countries), this.options.categories && s.category(this.options.categories), s.maxSuggestions(this.options.maxResults), s.run(function (e, t, s) {
                var i = [];
    ...
    var f = h.Control.extend({
        ...
        initialize: function (e) {
            h.Util.setOptions(this, e), e && e.providers && e.providers.length || ((e = e || {}).providers = [p()]), this._geosearchCore = c(this, e), this._geosearchCore._providers = e.providers, this._geosearchCore.addEventParent(this);
        ...
        onAdd: function (t) {
            ...
            return t.attributionControl && t.attributionControl.addAttribution(s), h.DomEvent.addListener(this._input, "focus", function (e) {
                ...
                for (var s, i = this._suggestions.querySelectorAll(".geocoder-control-suggestion"), o = this._suggestions.querySelectorAll(".geocoder-control-selected")[0], r = 0; r < i.length; r++) if (i[r] === o) {
                    s = r;
                    break
                }
                switch (e.keyCode) {
                ...
                var t = e.which || e.keyCode, s = (e.target || e.srcElement).value;
                ...
                27 !== t ? 13 !== t && 38 !== t && 40 !== t && this._input.value !== this._lastValue && (this._lastValue = this._input.value, h.DomUtil.addClass(this._input, "geocoder-control-loading"), this._geosearchCore._suggest(s)) : this._clearAllSuggestions()
    ...
    var v = r.FeatureLayerService.extend({
        options: {
            ...
            return t && s.intersects(t), this.options.idField && s.fields([this.options.idField].concat(this.options.searchFields)), s.run(function (e, t, s) {
                if (e) n(e, []); else {
            ...
            return t ? (delete i.params.where, i.featureIds([t])) : i.where(this._buildQuery(e)), s && i.within(s), i.run(h.Util.bind(function (e, t) {
                for (var s = [], i = 0; i < t.features.length; i++) {
                    var o, r, n = t.features[i];
                    n && (r = {
        ...
        options: {
            ...
            return this.find().text(e).fields(this.options.searchFields).returnGeometry(!1).layers(this.options.layers).run(function (e, t, s) {
                ...
                if (!e) {
                    ...
                    for (var r = 0; r < o; r++) {
                        var n = t.features[r], a = s.results[r], l = a.layerId, u = this._idFields[l];
            ...
            return (t ? (i = t.split(":")[0], l = t.split(":")[1], this.query().layer(l).featureIds(i)) : this.find().text(e).fields(this.options.searchFields).layers(this.options.layers)).run(function (e, t, s) {
                if (!e) {
                    ...
                    for (var i = 0; i < t.features.length; i++) {
                        var o, r, n = t.features[i];
                        l = l || s.results[i].layerId, n && void 0 !== l && (o = this._featureBounds(n), n.layerId = l, n.layerName = this._layerNames[l], n.displayFieldName = this._displayFields[l], r = {
                            latlng: o.getCenter(),
                            bounds: o,
                            text: this.options.formatSuggestion.call(this, n),
                            properties: n.properties,
    ...
    var _ = u.extend({
        options: {label: "Geocode Server", maxResults: 5}, suggestions: function (e, t, r) {
            if (this.options.supportsSuggest) {
                var s = this.suggest().text(e);
                return t && s.within(t), s.run(function (e, t, s) {
                    var i = [];
                    if (!e) for (; s.suggestions.length && i.length <= this.options.maxResults - 1;) {
                        var o = s.suggestions.shift();
                        o.isCollection || i.push({text: o.text, unformattedText: o.text, magicKey: o.magicKey})
